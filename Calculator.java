...
public class Calculator {
    ...
    private void initComponents(){
        ...
        JPanel panelButtons = new JPanel(new GridLayout(3,3,6,6));
        ...
        panelButtons.add(starButton);
        
        JButton garingButton = new JButton("/");
        panelButtons.add(garingButton);
        
        JButton equalButton = new JButton("=");
        panelButtons.add(equalButton);
        
        JButton persenButton = new JButton("%");
        panelButtons.add(persenButton);
        
        JButton modButton = new JButton("Mod");
        panelButtons.add(modButton);
